...
insert into employee (name, surname, login, password, role_id) values ('Denis', 'Turbal', 'dturball@gamail.com', 'password', 1);
insert into employee (name, surname, login, password, role_id) values ('Pavel', 'Kravchenko', 'pavelk@gamail.com', 'password', 2);
insert into employee (name, surname, login, password, role_id) values ('Uladzimir', 'Redzko', 'uredzko@gamail.com', 'password', 3);
